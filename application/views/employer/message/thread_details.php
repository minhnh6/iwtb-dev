...
<input type="hidden" id="contractorUserId" value="<?php echo $theadDetails['user_id'];?>">
...
<script type="text/javascript">
    ...
    function addNewMessage(messageContent) {
        ...
        var contractorUserId = $("#contractorUserId").val();
        
        
        $.ajax({
            method: "POST",
            async: false,
            url: baseUrl+"employer/message/addNewMessage/"+threadId+"/"+contractorUserId,
    ...
    function getLatestMessageUpdate(appendWithOldText) {
        ...
        $.ajax({
            method: "POST",
            async: false,
            url: baseUrl+"employer/message/getLatestMessageUpdate/"+threadId+"/"+lastMessageIdShown,
            data: {}
        })
         .done(function( msg ) {
    ...
    $("#messageContent").on("focus", function(){
        ...
        $.ajax({
            method: "POST",
            async: false,
            url: baseUrl+"employer/message/updateUnreadMessageStatus/"+threadId,
            data: {}
        })
         .done(function( msg ) {
        });
