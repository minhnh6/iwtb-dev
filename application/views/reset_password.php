                    ...
                    <div class="row ted">
                        <div class="col-sm-12">
                            <div class="white-box">
                                ...
                                <center><p class="text-muted m-b-30"> Please enter new password! </p></center>
                                <hr>
                                <form action="<?=base_url();?>reset_password" method="POST" data-toggle="validator">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">                                           
                                            <div class="col-sm-12">
                                             ...
                                             <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label for="inputEmail" class="control-label">Confirm Password Again</label>
                                                    <input type="password" class="form-control" id="re_password" name="re_password" placeholder="Retype password" required>
                                                    <div class="help-block with-errors"></div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <button type="submit" name="submitResetPassword" class="btn btn-primary">Submit</button>
                                                    <a href="<?=base_url();?>login" target="_self" class="btn btn-danger">Cancel</a>
                                                </div>
                                            </div>                                           
                                        </div>
                                    </div>
