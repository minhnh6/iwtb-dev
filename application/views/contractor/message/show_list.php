                ...
                <div class="white-box">
                    ...
                    <div class="row">
                        <div class="col-lg-2 col-md-3  col-sm-4 col-xs-12 ">
                            <div class="p-r-20"> <a class="btn btn-danger btn-block waves-effect waves-light">My Messages</a>
                                <div class="list-group mail-list m-t-20"> 
                                    <a href="" class="list-group-item active">Inbox <span class="label label-rouded label-success pull-right unreadMessageCount"><?php echo $totalUnredMessages; ?></span></a>  
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-10 col-md-9 col-sm-8 col-xs-12 mail_listing">
                            ...
                            <div class="btn-group">
                                <a href="<?php echo base_url(); ?>contractor/message/showList" class="btn btn-default waves-effect waves-light"> <i class="fa fa-refresh"></i> </a>
                            </div>
                            <hr class="m-b-0">
                            <div class="message-center"> 
                                ...
                                <?php
                                    ...
                                    foreach($threadList as $aThread) {
                                        ...
                                        $threadUrl = base_url() . "contractor/message/showThread/{$aThread['thread_id']}";
                                        
                                        echo "
                                                <a href='showThread/{$aThread['thread_id']}' class='{$readClass}'>
                                                    <div class='user-img'> <img class='img-circle' alt='user' src='{$baseUrl}assets/images/default-avatar.png'> </div>
                                                    <div class='mail-contnet'>
                                                        <h5>{$aThread['name']} <small>[ {$aThread['first_name']} {$aThread['surename']} ] <small> </h5>
...
<script type="text/javascript">
    ...
    function getLatestNoOfIncomingMessage() {
        ...
        $.ajax({
            method: "POST",
            async: true,
            url: baseUrl+"contractor/message/getlastSeenMessageId/" + lastSeenMessageId,
            data: {}
        })
         .done(function( msg ) {
