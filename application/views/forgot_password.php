                    ...
                    <div class="row ted">
                        <div class="col-sm-12">
                            <div class="white-box">
                                ...
                                <center><p class="text-muted m-b-30"> Provide your email to reset your password! </p></center>
                                <hr>
                                <form action="<?=base_url();?>forgotPassword" method="POST" data-toggle="validator">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label for="inputEmail" class="control-label">Email address</label>
                                                    <input type="email" class="form-control" id="email_address" name="email_address" placeholder="Ex. someone@anything.com" required>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <button type="submit" name="submitForgotPassword" class="btn btn-primary">Submit</button>
